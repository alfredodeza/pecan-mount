...
class TestTwoApps(object):
    ...
    def test_not_found_if_root_is_empty(self):
        ...
        pecan_mount.tree.mount(None, '/bar', self.conf)
        app = TestApp(pecan_mount.tree)
    ...
    def test_run_two_nested_apps(self):
        pecan_mount.tree.mount(None, '/foo/baz', self.conf)
        pecan_mount.tree.mount(None, '/bar/foo/foo', self.conf)
        app = TestApp(pecan_mount.tree)
